...
describe SimpleSelector::Segment do
  ...
  describe "instance" do
    ...
    describe ".new('tag')" do
      ...
      its(:to_s       ) { should == 'tag' }
      its(:inspect    ) { should == %Q{#<SimpleSelector::Segment "tag">} }
      its(:specificity) { should eq(SimpleSelector::Specificity.new(0,0,0,1)) }
    end
    ...
    describe ".new('#the_id')" do
      ...
      its(:inspect    ) { should == %Q{#<SimpleSelector::Segment "#the_id">} }
      its(:specificity) { should eq(SimpleSelector::Specificity.new(0,1,0,0)) }
    end
    ...
    describe ".new('.class_name')" do
      ...
      its(:inspect    ) { should == %Q{#<SimpleSelector::Segment ".class_name">} }
      its(:specificity) { should eq(SimpleSelector::Specificity.new(0,0,1,0)) }
    end
    ...
    describe ".new('tag#the_id.class_name_1.class_name_2')" do
      ...
      its(:inspect    ) { should == %Q{#<SimpleSelector::Segment "tag#the_id.class_name_1.class_name_2">} }
      its(:specificity) { should eq(SimpleSelector::Specificity.new(0,1,2,1)) }
    end
