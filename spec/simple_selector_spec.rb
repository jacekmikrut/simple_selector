...
describe SimpleSelector do
  ...
  describe "instance" do
    ...
    describe ".new('')" do
      ...
      its(:to_s       ) { should == ''   }
      its(:inspect    ) { should == %Q{#<SimpleSelector "">} }
      its(:specificity) { should eq(SimpleSelector::Specificity.new(0,0,0,0)) }
    end
    ...
    describe ".new('tag.class')" do
      ...
      its(:inspect    ) { should == %Q{#<SimpleSelector "tag.class">} }
      its(:specificity) { should eq(SimpleSelector::Specificity.new(0,0,1,1)) }
    end
    ...
    describe ".new('tag.class #id .class')" do
      ...
      its(:inspect    ) { should == %Q{#<SimpleSelector "tag.class #id .class">} }
  ...
  describe "#concat" do
    ...
    describe 'SimpleSelector.new("tag#id")' do
  ...
  describe "#duplicate" do
    ...
    it "should return instance of SimpleSelector" do
      subject.duplicate.should be_a(SimpleSelector)
    end
